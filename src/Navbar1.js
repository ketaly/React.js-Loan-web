...
function Navbar1() {
  ...
  const toggleSignUpModal = () => {
    ...
    <nav class="navbar fixed-top  navbar-expand-md navbar-dark shadow">
      ...
      <Link to="0/" class="navbar-brand" style={{ textDecoration: 'none' }}><img src="" width="50" height="50" class="d-inline-block align-center" alt="" />Capital Smart <span className="loan">Loan</span></Link>
