...
<div>
      <div className="container">
        ...
        <div className="col-md-6 col-12 col-lg-6 head">
            <h2 className='heading' style={{color: "green"}}>Distributors Loan</h2>
            <h5 style={{color:'white',fontWeight:'600'}}>from ₦1,000 for Distributors</h5>
            <p id="indi-animatedDiv" className={`indi-animated-div pes ${isVisible ? 'indi-slide-in' : ''}`}>
            Distributors Loan Plan Package


Welcome to Capital Smart Loan, the trusted platform for distributors seeking financial assistance. Our Distributors Loan Plan Package is specifically designed to meet the unique needs of distributors like you. Here's a concise overview of our plan:
<p>Quick Approval: We value your time and the urgency of your business requirements. Our efficient loan approval process ensures quick turnaround times, enabling you to access the funds promptly.</p>
<p>Flexible Repayment Options: We understand the cash flow fluctuations that distributors often face. Our loan plan provides flexible repayment options, allowing you to align your repayments with your revenue streams and business cycles.</p>
<p>Quick Approval: We value your time and the urgency of your business requirements. Our efficient loan approval process ensures quick turnaround times, enabling you to access the funds promptly.</p>
...
<button className='btn btn-success custom-button'><span>Apply now</span></button>
          ...
          <div className="indi-img col-md-11 col-11 col-lg-11">
            <img src="./images/dis.jpg" alt="" srcset="" className='col-md-8 col-10 col-lg-8'/>
          </div>
          </div>
        </div>
      </div>
